...
# VERSION: 1.1.0
# TAGS: docker podman vm containers libvirt kvm
# DEPS: none
# INFO: Docker, Podman, libvirt (virt-manager) with distrobox, Looking Glass
# ============================================================================
{ config, pkgs, lib, ... }:

let
  cfg = config.atlas.modules.virtualisation;
in {
  options.atlas.modules.virtualisation = {
  ...
  config = {
    ...
    services.udev.extraRules = ''
      KERNEL=="kvmfr*", OWNER="${cfg.username}", GROUP="kvm", MODE="0660"
    '';
